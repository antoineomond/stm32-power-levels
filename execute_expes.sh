...
NB_EXPES=4 # nb_confs * nb_benchmarks
NB_ITERS=1
NB_BENCHMARKS=4
...
cd /home/aomond/research/projet_sensor_loic_2025/stm32/cubeide_workspace && /opt/st/stm32cubeide_2.2.0/stm32cubeide --launcher.suppressErrors -nosplash -application org.eclipse.cdt.managedbuilder.core.headlessbuild -data . -build expes-power && cd - 
